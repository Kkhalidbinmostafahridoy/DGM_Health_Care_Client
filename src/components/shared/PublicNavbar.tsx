...
export default function PublicNavbar() {
  ...
  // Safe fallback object to prevent runtime errors when t or t.navbar is undefined
  const nav = t?.navbar || {
    home: "Home",
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-80 overflow-y-auto">
              <SheetHeader className="border-b border-slate-100 pb-4 text-left">
                ...
                <SheetDescription className="sr-only">
                  {nav.mobileMenuDesc || "Main navigation menu"}
                </SheetDescription>
              </SheetHeader>
              ...
              <div className="mt-6 border-t border-slate-100 px-4 pt-4 pb-6">
                ...
                >
                  <PhoneCall className="h-4 w-4" aria-hidden />
                  {nav.emergency || "Emergency"}: +880 1756-959451
                </a>
              </div>
            </SheetContent>
          </Sheet>
