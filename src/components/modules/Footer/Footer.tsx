...
const CONTACT_ITEMS: ContactItem[] = [
  {
    icon: MapPin,
    label: "Visit Us",
    value: "DGM Health Campus, Road 11, Banani, Dhaka 1213",
  },
  {
    icon: PhoneCall,
    label: "Appointments",
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            ...
            >
              {/* DGM LOGO on elevated white card */}
              ...
              <span className="flex flex-col leading-none">
                ...
                <span className="mt-1.5 bg-linear-to-r from-sky-400 to-emerald-400 bg-clip-text text-[10px] font-semibold uppercase tracking-[0.2em] text-transparent"></span>
              </span>
            </Link>
